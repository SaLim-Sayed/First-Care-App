/**
 * Symptom taxonomy and checkbox state defaults for Smart Diagnosis (Prediction).
 * Keys/order must stay aligned with the ML backend `posts` vector indexing.
 */

export const SYMPTOM_KEYS_EN = {
    skin: [
      "dichromic _patches",
...
export const INITIAL_SYMPTOM_POSTS = {
